...
# For Linux with Mosquitto client

# Configuration
MQTT_HOST=""
MQTT_TOPIC="TTT"
# Just use commands directly, assuming they're in the PATH
...
start_board_listener() {
    ...
    {
        $MOSQUITTO_SUB -h $MQTT_HOST -t "$MQTT_TOPIC/#" -v | while read -r line; do
...
monitor_game() {
    ...
    $MOSQUITTO_SUB -h $MQTT_HOST -t "$MQTT_TOPIC/#" -v
    echo "Press Enter to continue..."
    read
}
